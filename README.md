...
This project is an API built using **Java, Spring Boot, AWS SNS, SQS, S3 and Lambda and MongoDB.**
...
```bash
git clone https://github.com/diogoazevedoo/challenge-anota-ai.git
```
